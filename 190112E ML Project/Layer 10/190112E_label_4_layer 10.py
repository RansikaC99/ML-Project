...
model_initial = SVC()
model_initial.fit(train_X_scaled, label4_train_y)
...
# label4_pca_train_features_transformed = pca_transformer.fit_transform(train_X_scaled)
# label4_pca_valid_features_transformed = pca_transformer.transform(valid_X_scaled)
# label4_pca_test_features_transformed = pca_transformer.transform(test_X_scaled)
#
# print(label4_pca_train_features_transformed.shape)
#
# model_final = SVC()
# model_final.fit(label4_pca_train_features_transformed, label4_train_y)
#
# y_pred = model_final.predict(label4_pca_valid_features_transformed)
#
# accuracy = accuracy_score(label4_valid_y, y_pred)
#
