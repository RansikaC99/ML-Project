...
model_initial = SVC()
model_initial.fit(train_X_scaled, label2_train_y.values.ravel())
...
model_nxt = SVC()
model_nxt.fit(label2_pca_train_features_transformed, label2_train_y.values.ravel())

y_pred = model_nxt.predict(label2_pca_valid_features_transformed)

accuracy_intial = accuracy_score(label2_valid_y, y_pred)

print("after pca Accuracy:", accuracy_intial)
...
random_search.fit(label2_pca_train_features_transformed, label2_train_y)
...
best_model.fit(label2_pca_train_features_transformed, label2_train_y)

# Predict on the train data using the best model
y_pred_train_label2 = best_model.predict(label2_pca_train_features_transformed)
...
y_pred_valid_label2 = best_model.predict(label2_pca_valid_features_transformed)

# Calculate accuracy on the validation data
accuracy_valid = accuracy_score(label2_valid_y, y_pred_valid_label2)

y_pred_test_label2 = best_model.predict(label2_pca_test_features_transformed)
